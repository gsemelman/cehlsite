...
<div style="display:none; margin-left:auto; margin-right:auto; width:850px; border:solid 1px<?php echo $couleur_contour; ?>" id="windowSearch">
	<div class="titre"><span class="bold-blanc"><?php echo $compareTitle; ?></span></div>
	<div style="float:left; height:300px; width:120px; overflow: auto;">
		<?php
		for($i=0;$i<count($gmequipe);$i++) {
			echo '<a id="side1t'.$i.'" style="display:block; width:100%;" class="lien-noir" href="javascript:selectTeam(\'1\',\''.$i.'\');">'.$gmequipe[$i].'</a>';
		}
		?>
	</div>
	<div id="team1" style="float:left; height:300px; width:305px; overflow: auto;">
		<?php echo $compareSelectTeam; ?>
	</div>
	<div style="float:left; height:300px; width:120px; overflow: auto;">
		<?php
		for($i=0;$i<count($gmequipe);$i++) {
			echo '<a id="side2t'.$i.'" style="display:block; width:100%;" class="lien-noir" href="javascript:selectTeam(\'2\',\''.$i.'\');">'.$gmequipe[$i].'</a>';
		}
		?>
	</div>
	<div id="team2" style="float:left; height:300px; width:305px; overflow: auto;">
		<?php echo $compareSelectTeam; ?>
	</div>
	<div style="clear:both"><input onclick="javascript:searchResult();" style="width:100%;" type="button" value="<?php echo $compareCompare; ?>"></div>
</div>

<div id="windowResult" style="display:none; margin-top:20px; margin-left:auto; margin-right:auto; width:850px; border:solid 1px<?php echo $couleur_contour; ?>">
