		...
		<div class="card-body">
			...
			<div id="standingsTabs">
				<ul class="nav nav-tabs nav-fill">
					<li class="nav-item"><a class="nav-link <?php echo $seasonActive?>" href="#Season"
						data-toggle="tab">Regular Season</a></li>
					<li class="nav-item"><a class="nav-link <?php echo $playoffActive?>" href="#Playoffs"
						data-toggle="tab">Playoff Tree</a></li>
				</ul>
...
if (file_exists($Fnm)) {
    ...
    while (list ($cle, $val) = myEach($tableau)) {
        ...
        if (substr_count($val, 'HREF=') || ($currentFarm == 1 && substr_count($val, '<') == false)) {
            ...
            if ($equipe == $currentTeam || ($currentFarm == 1 && isset($TSabbr) && substr_count($val, '(' . $TSabbr)))
            ...
            if ($currentFarm == 0)
                echo '<td style="' . $bold . '">' . $serie . '</td>';
            if ($currentFarm == 0)
                echo '<td style="' . $bold . '"><a style="display:block; width:100%;" href="TeamRosters.php?team=' . $equipe . '">' . $equipe . '</a></td>';
            if ($currentFarm == 1)
                echo '<td style="' . $bold . '">' . $equipe . '</td>';
            ...
            if ($currentFarm == 0 && $e == 1)
                echo '<td style="text-align:right;' . $bold . '">' . $standingsOL . '</td>';
            ...
            if ($currentFarm == 0)
                echo '<td style="text-align:right;' . $bold . '">' . $standingsL10 . '</td>';
            if ($currentFarm == 0)
                echo '<td style="text-align:right;' . $bold . '">' . $standingsSTK . '</td>';
            echo '</tr>';
