...
// 								}
								...
								if($status[$i] == 'game'){
								    if($equipe1[$i] == $currentTeam || $equipe2[$i] == $currentTeam) {
										...
										echo '<td '.$bold.'"><a class="lien-noir" style="display:block; width:100%;" href="games.php?num='.$number[$i].$linkRnd.'">'.$dayArray[$i].'</a></td>';
								...
								if($status[$i] == 'at'){
								    if($equipe1[$i] == $currentTeam || $equipe2[$i] == $currentTeam) {
										...
										echo '<tr class="hover'.$c.'">';
										echo '<td style="width:40px;'.$bold.'">'.$dayArray[$i].'</td>';
