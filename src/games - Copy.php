...
while(list($cle,$val) = myEach($tableau)) {
	...
	if(substr_count($val, ' at ') && $a == 0){
		...
		echo '<div style="text-align:center; font-weight:bold;">'.$equipe1.' Vs '.$equipe2.'</div>';
	...
	if(substr_count($val, 'Game Stars')) {
		echo '</table></div><div style="position: relative; text-align:left; float:right;"><table class="tableau" style="width:260px;">
	...
	if(substr_count($val, 'Power Play Conversions')) {
		echo '</table><div style="position: relative; text-align:left; float:left;"><table class="tableau" style="width:260px;">
